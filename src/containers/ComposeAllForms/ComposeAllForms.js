...
const ComposeAllForms = ({ dataForm }) => {
    ...
    return ( <
        ...
        { currentStep === 1 && < FirstStepForm / > } { currentStep === 2 && < SecondStepForm / > } { currentStep === 3 && < ThirdStepForm / > } { currentStep === 4 && < FourthStepForm / > } { currentStep === 5 && < FivethStepForm / > } { currentStep === 6 && < LastStep / > } <
        /Box> <
        /Item>
    );
};
